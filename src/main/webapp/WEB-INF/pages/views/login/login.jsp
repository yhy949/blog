...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="${home}/js/font-awesome/css/font-awesome.min.css">
		<link rel="stylesheet" href="${home}/css/login/css/form-elements.css">
        <link rel="stylesheet" href="${home}/css/login/css/style.css">
        ...
        <link rel="apple-touch-icon-precomposed" href="${home}/images/assets/ico/apple-touch-icon-57-precomposed.png">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="${home}/login/index.do" method="post" class="login-form">
        ...
        <script src="${home}/js/login/jquery.backstretch.min.js"></script>
        <script src="${home}/js/login/scripts.js"></script>
        <!--[if lt IE 10]>
